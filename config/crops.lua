...
Config.Crops = {
    carrot = {
        ...
        nutrients = { decayPerHour = 10, optimalMin = 42, optimalMax = 82, overfertilizeCeiling = 100 },
        weeds = { growthPerHour = 18, resistance = 0.55 },
        pests = { onsetHours = 0.35, susceptibility = 0.35 },
    ...
    potato = {
        ...
        nutrients = { decayPerHour = 8, optimalMin = 36, optimalMax = 85, overfertilizeCeiling = 100 },
        weeds = { growthPerHour = 15, resistance = 0.7 },
        pests = { onsetHours = 0.5, susceptibility = 0.2 },
    ...
    lettuce = {
        ...
        nutrients = { decayPerHour = 22, optimalMin = 55, optimalMax = 82, overfertilizeCeiling = 100 },
        weeds = { growthPerHour = 28, resistance = 0.15 },
        pests = { onsetHours = 0.12, susceptibility = 0.8 },
    ...
    tomato = {
        ...
        nutrients = { decayPerHour = 16, optimalMin = 52, optimalMax = 78, overfertilizeCeiling = 100 },
